var debug=true;
if(debug)alert("Testing SwapBootstrapExample()");
...
for(var i=0;i<exampleNames.length;i++){
	...
	var htmlPath = path+exampleNames[i];
	alert(htmlPath);
...
*/
  // alert(output);
	//$.ajax({ url: htmlPath, success: function(data) { alert(data); } });
	//document.write('<!DOCTYPE HTML><html>'+htmlPath+'</html>');
	//document.close();
}
